    ...
    <div class="row">
        ...
        @foreach ($c as $user)
            <tr>
                ...
                <td><button id="myBtnqw" onclick="document.getElementById('myModalqw').style.display = 'block';document.getElementById('des').value = '{{$user->Description}}';document.getElementById('link').value='{{ $user->Link}}';document.getElementById('id').value='{{ $user->id}}';document.getElementById('ename').value='{{ $user->EName}}';document.getElementById('date').value='{{ $user->Date}}';" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></button></td>
