...
<div class="nav-side-menu">
 ...
 <div id="page-wrapper">
    <div class="row">
        ...
        <div class="border"><span>Upcoming Events</span></div><div><button onclick="document.getElementById('myModalqw2').style.display = 'block';" id="myBtnqw2" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></button></div>
        ...
        @foreach ($c as $user)
            <tr>
                ...
                <td><a><button id="myBtnqw" onclick="document.getElementById('myModalqw').style.display = 'block';document.getElementById('des').value = '{{$user->Description}}';document.getElementById('link').value='{{ $user->Link}}';document.getElementById('id').value='{{ $user->id}}';document.getElementById('ename').value='{{ $user->EName}}';document.getElementById('date').value='{{ $user->Date}}';" class="btn btn-primary">Edit</button></a>
                &nbsp;<a href="{{route('delue',$user->id)}}" onclick="return confirm('Are you sure?')",
