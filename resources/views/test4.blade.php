...
<body>
    ...
    <header class="header header_style_01">
     ...
     <li><a href="login"><span class="glyphicon glyphicon-log-in"></span><form method="POST" action="{{ route('logout') }}">
                            @csrf
...
<br>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="spps">Project</a></li>
                        <li><a href="snotifi">Notifications</a></li>
                        <li><a id="myBtn" >Edit Profile</a></li>
