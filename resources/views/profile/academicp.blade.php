    ...
    <div id="checkboxes" >
      ...
      <label for="two">
       ...
       <label for="twelve">
        ...
        <!--label for="thirty">
        <input type="checkbox" id="Data Minning and Machine Learning" name="FieldOfSpecialization[]" value="Machine Learning" />Machine Learning</label>
        <label for="thirtyone">
        ...
        <div title=""><b></b>Research Interest</b></div> <select><div>
